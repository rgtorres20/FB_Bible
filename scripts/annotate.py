...
SYSTEM_PROMPT = (
    ...
    "points, each team's 2025 offense profile). TWO short sentences (max "
    "210 chars total): what the market expects, and what the '25 profiles "
    "say about how each side gets there; no picks. Reply key: the game "
    "key.\n"
    "\n"
